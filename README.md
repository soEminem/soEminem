# 💫 About Me:
Web developer 👨‍💻<br>JS Lover 👾<br>A.I Interested🤖<br>knowledge in:  📚<br>Node.js, HTML, CSS, JS + (jQuery + TypeScript), Angular,Java<br>Database: 💭<br>MongoDB , MySql

# My portafolio 
https://portafolio-gold-phi.vercel.app/
